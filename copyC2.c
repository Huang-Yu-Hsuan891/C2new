...
int main(){
    ...
    for (step = 0; step < 1; step++) {
        ...
        totalerror1 = 0;
        totalerror2 = 0;
        while (s < 100 ) {                                // compute the number of transmit block 
             // initial
            ...
            // the int1.412538erative decoding algotrithm
            ...
            if(totalerror2 != 0)printf("totalerror2 = %d\n", totalerror2); 
             FILE *outfp2; 
             outfp2 = fopen("C2_LEVEL1_1_8_iteration=50_totalerror.txt","a");
    ...
    outfp = fopen("C2_LEVEL1_1_8_iteration=50_vr2.txt","w");
    for (i = 0; i < 1; i++) {
